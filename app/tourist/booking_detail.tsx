        ...
        { text: "No", style: "cancel" },
        {
          ...
          onPress: async () => {
            try {
              ...
              const response = await fetch(`${API_URL}/api/tourist/bookings/${booking.id}/cancel`, {
                method: "PATCH",
                headers: {
                  "Content-Type": "application/json",
                  Authorization: `Bearer ${token}`,
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        {/* Guide Info Card */}
        <TouchableOpacity style={styles.guideCard} onPress={handleViewGuideProfile}>
          <Image source={{ uri: guideAvatarUri }} style={styles.guideAvatar} />
          <View style={styles.guideInfo}>
            <Text style={styles.guideName}>{booking.guide.name || booking.guide.username}</Text>
        ...
        {/* Payment Countdown (for accepted bookings) */}
